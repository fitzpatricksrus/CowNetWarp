...
public class Warp {
     ...
     */
    public Warp(OpenWarp ow, String warpName, ConfigurationSection node) {
        this.plugin = ow;
        this.name = warpName;
     ...
     */
    private void parseConfiguration(ConfigurationSection node) {
        ...
        this.invitees = node.getStringList(INVITEES_KEY);
    }
