...
public class OWWarpDeleteCommand extends OWCommand {
    ...
    public void runCommand(CommandSender sender, List<String> args) {
        ...
        if (this.getPlugin().getPublicWarps().containsKey(warpName)) {
            ...
            if (sender instanceof Player && sender.getName().equals(owner)) {
                permNode = "self";
            }

            if (!getPlugin().hasPermission(sender, "openwarp.warp.delete.public." + permNode, false)) {
            ...
            if (!getPlugin().hasPermission(player, "openwarp.warp.delete.private", false)) {
